...
package com.example.administrator.prepaidcarddemo.zxing;
...
import com.example.administrator.prepaidcarddemo.zxing.camera.CameraManager;
import com.example.administrator.prepaidcarddemo.zxing.manager.BeepManager;
import com.example.administrator.prepaidcarddemo.zxing.manager.InactivityTimer;
import com.example.administrator.prepaidcarddemo.zxing.utils.ZXingUtils;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public void onCreate(Bundle icicle) {
        ...
        btn_close.setOnClickListener(v -> finishCancle());

        btn_photo.setOnClickListener(v -> getImageFromAlbum());

        btn_dialog_bg.setOnClickListener(v -> {
